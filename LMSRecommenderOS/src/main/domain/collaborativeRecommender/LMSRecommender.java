...
public class LMSRecommender extends StandardLMSRecommender {
	 ...
	 * filtering.
	 */
	private static final int K_USERS = 10;
	 ...
	 */
	private static final int CORR_ITEMS = 20;
	...
	public void cycle(CBRQuery query) throws ExecutionException {
		...
		Collection<RetrievalResult> res = LMSCollaborativeRetrievalMethod
				.getRecommendation((LMSPearsonMatrixCaseBase) caseBase, query,
						K_USERS);
		log.info("Query: " + query.getDescription());

		Collection<CBRCase> selectedCases = SelectCases.selectTopK(res, TOP_K);
